                    ...
                    <div class="row product-list product-detail">
                        ...
                        <div class="col-12 col-lg-6 text-center text-lg-left">
                            <div class="product-single-price">
                                <h4><span class="real-price">{{ number_format($product->Price) }} VNĐ</span> <span><del>$450</del></span></h4>
                            ...
                            <div class="product-tags-list">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><span class="d-inline">Categories: <a href="javascript:void(0)">Classic</a><span class="comma-separtor">,</span><a href="javascript:void(0)">{{ $product->category->CategoryName }}</a></span></li>
